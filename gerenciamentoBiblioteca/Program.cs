...
class Biblioteca
{
    ...
    {
        if (limitePorUsuario[usuario] >= limite)
        {
    ...
    static void DevolverLivro(string usuario)
    {
        ...
        {
            Console.WriteLine("Livro não encontrado nos empréstimos.");
        }
    }

    static void VerificarLimite(string usuario, int limite)
    {
        Console.WriteLine($"Você emprestou {limitePorUsuario[usuario]} de {limite} livros permitidos.");
    }
}
